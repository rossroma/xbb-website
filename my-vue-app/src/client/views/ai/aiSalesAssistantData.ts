...
function toImageCardGridItem(tab: {
  key?: string
  label: string
  description?: string
  image?: string
...
export const coachSection = {
  ...
  cards: [
    toImageCardGridItem({
      ...
      image: realScenarioSimulationImage,
    ...
    toImageCardGridItem({
      ...
      image: teamTrainingTemplateImage,
